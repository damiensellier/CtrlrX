...
// --- SimpleEmbeddedDataManager Class (omitted for brevity, assume unchanged) ---
...
const Result CtrlrLinux::exportWithDefaultPanel(CtrlrPanel *panelToWrite, const bool isRestricted, const bool signPanel)
{
    ...
    if (isVST3 || isVST2) {
        ...
        if (newMe.loadFileAsData(binaryData)) {
            ...
            // --- NEW: Create the replacement byte block for the plug type (16 bytes) ---
            ...
            // --- NEW: Define the hex search string for "Instrument|Tools" (16 bytes) ---
            ...
            // --- NEW: Perform the VST3 plug type replacement ---
...
// --- Getter functions (omitted for brevity, assume unchanged) ---

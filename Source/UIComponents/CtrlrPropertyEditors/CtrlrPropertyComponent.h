...
#include "Ctrlrlog.h"
#include "CtrlrPanel/CtrlrPanelEditorIcons.h"
...
private:
	...
	ScopedPointer<DrawableButton> apply;
};
...
private:
	...
	ScopedPointer<Label> fontSizeLabel; // Added v5.6.34. Thanks to @dnaldoog
	ScopedPointer<Label> horizontalScaleLabel; // Added v5.6.34. Thanks to @dnaldoog
	ScopedPointer<Label> kerningLabel; // Added v5.6.34. Thanks to @dnaldoog
};
